...
PRODUCT_SYSTEM_PROPERTIES += \
    log.tag.CCodec=$(VENDOR_LOG_LEVEL) \
    log.tag.MediaCodec=$(VENDOR_LOG_LEVEL) \
	log.tag.MediaPlayerService=$(VENDOR_LOG_LEVEL) \
	log.tag.CCodecBufferChannel=$(VENDOR_LOG_LEVEL) \
	log.tag.MediaCodecSource=$(VENDOR_LOG_LEVEL) \
	log.tag.NuPlayerRenderer=$(VENDOR_LOG_LEVEL) \
	log.tag.NuPlayerDecoder=$(VENDOR_LOG_LEVEL) \
	log.tag.NuPlayer=$(VENDOR_LOG_LEVEL) \
	log.tag.MPEG4Writer=$(VENDOR_LOG_LEVEL) \
	log.tag.CCodecBuffers=$(VENDOR_LOG_LEVEL) \
	log.tag.CCodecConfig=$(VENDOR_LOG_LEVEL) \
	log.tag.MediaCodecList=$(VENDOR_LOG_LEVEL) \
	log.tag.FrameDecoder=$(VENDOR_LOG_LEVEL) \
	log.tag.MediaMetadataRetriever=$(VENDOR_LOG_LEVEL) \
	log.tag.MediaCodecsXmlParser=$(VENDOR_LOG_LEVEL) \
	log.tag.NuPlayerDriver=$(VENDOR_LOG_LEVEL) \
	log.tag.StagefrightRecorder=$(VENDOR_LOG_LEVEL) \
	log.tag.GenericSource=$(VENDOR_LOG_LEVEL) \
	log.tag.GraphicBufferSource=$(VENDOR_LOG_LEVEL)