...
LOCAL_C_INCLUDES := \
        ...
        $(LOCAL_PATH)/util \
        $(LOCAL_PATH)/HAL3 \
        $(TARGET_HALS_PATH)/media/libstagefrighthw \
        $(TARGET_HALS_PATH)/media/mm-core/inc \
...
LOCAL_C_INCLUDES += \
        device/xiaomi/jasmine_sprout/qcom-caf/camera/QCamera2/HAL
...
LOCAL_C_INCLUDES += \
        $(TARGET_HALS_PATH)/display/libqservice
